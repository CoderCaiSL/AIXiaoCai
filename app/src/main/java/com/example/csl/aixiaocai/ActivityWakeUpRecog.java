...
import com.example.csl.aixiaocai.control.MyRecognizer;
import com.example.csl.aixiaocai.control.MyWakeup;
import com.example.csl.aixiaocai.recognization.IStatus;
import com.example.csl.aixiaocai.recognization.MessageStatusRecogListener;
import com.example.csl.aixiaocai.recognization.PidBuilder;
import com.example.csl.aixiaocai.recognization.StatusRecogListener;
import com.example.csl.aixiaocai.wakeup.IWakeupListener;
import com.example.csl.aixiaocai.wakeup.RecogWakeupListener;
...
public class ActivityWakeUpRecog extends ActivityWakeUp implements IStatus {
    ...
    public static void ActionStart(Context context){
        Intent intent = new Intent(context,ActivityWakeUpRecog.class);
